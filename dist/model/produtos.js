...
let Produtos = (() => {
    let Produtos = class Produtos extends sequelize_typescript_1.Model {
    };
    __decorate([
    ...
    __decorate([
        sequelize_typescript_1.Column,
        __metadata("design:type", String)
    ], Produtos.prototype, "tipo", void 0);
    Produtos = __decorate([
        sequelize_typescript_1.Scopes(() => ({})),
        sequelize_typescript_1.Table({ tableName: "produtos", timestamps: false })
    ], Produtos);
    return Produtos;
})();
